...
public class ProviderProviderDicountApi extends ProviderBaseApi {

    @Autowired
    private ProviderComponent providerComponent;

    @ApiAction(value = "app.provider.provider.discount.add")
    ...
    @ApiAction(value = "app.provider.provider.discount.delete")
