...
@Entity
@Table(name = "saman_reverse_transaction_info_response" , schema = "public")
public class SamanReverseTransactionInfoResponseEntity extends BaseEntity {
    ...
    private Set<SamanReverseTransactionResponseEntity> samanReverseTransactionResponseEntities;


    public SamanReverseTransactionInfoResponseEntity() {
    }

    public SamanReverseTransactionInfoResponseEntity(String rrn, String refNum, String maskedPan, String hashedPan, long terminalNumber, long orginalAmount, long affectiveAmount, String straceDate, String straceNo) {
        this.rrn = rrn;
        this.refNum = refNum;
    ...
    public SamanReverseTransactionInfoResponseEntity(SamanVerifyInfoRestResponse vi) {
        this(
                vi.getRRN(),
                vi.getRefNum(),
                vi.getMaskedPan(),
