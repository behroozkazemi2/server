...
//
Date.prototype.getJalaliDateText = function() {
	var gd = this.getDate();
	var gm = this.getMonth();
	var gy = this.getFullYear();
	var j = JalaliDate.gregorianToJalali(gy, gm+1, gd);
	return week[(this.getDay())] + ' ' + j[2] + ' ' + month[j[1]-1] + ' ' + j[0];
}

Date.prototype.getJalaliFullDateString = function() {
    var gd = this.getDate();
    var gm = this.getMonth();
    var gy = this.getFullYear();
    var j = JalaliDate.gregorianToJalali(gy, gm+1, gd);
