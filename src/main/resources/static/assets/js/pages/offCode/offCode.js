...
//     <th>عملیات</th>
    ...
    loadDataTable = function(response){
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            var typeName = "";
            if(product.forProvider){
                typeName = "<p class='text-danger'>تمام محصولات</p>";
            }else if(product.forProductProvider){
                typeName = product.productProviderName;
            }else if(product.forCustomer){
                typeName ="<p>"+product.customerFirstName+" "+product.customerLastName+"</p><p>"+product.customerMobile+"</p>";
            }else if(product.forAll){
                typeName = "<p class='text-danger'>تمام مشتریان</p>";
            }else{
